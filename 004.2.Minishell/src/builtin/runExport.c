...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/31 08:14:27 by segungor          #+#    #+#             */
/*   Updated: 2023/08/31 08:14:28 by segungor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	change_env(char *envname, char *arg, int is_equal)
{
	t_env	*env;
...
static void	double_export_arg(char *env_cmd)
{
	char	*arg;
	int		is_equal;
	t_env	*env;
...
static void	single_export_arg(t_cmdlist *cmd_node)
{
	t_env	*env;
