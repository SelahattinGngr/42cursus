 ...
 *
 * The Channel class encapsulates the properties and behaviors of an IRC channel.
 * It provides methods to manage clients, set channel modes, and broadcast messages.
 */
class Channel
{
	private:
